  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.role !== 'ADMIN') {
          alert("Chỉ quản trị viên mới được phép đăng nhập.");
          return;
        }
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4">
        <div className="max-w-md w-full">
          <div className="p-8 rounded-2xl bg-white shadow">
            <h2 className="text-slate-900 text-center text-3xl font-semibold">Đăng nhập</h2>
            <p className="text-center text-sm text-gray-500 mt-2">Chỉ dành cho quản trị viên</p>
